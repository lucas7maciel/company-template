...
export const Language = (props) => {
  ...
  const brStyle = props.portuguese ? styles.current_flag : styles.other_flag;

  const usaStyle = !props.portuguese ? styles.current_flag : styles.other_flag;
  ...
  return (
    ...
    >
      <div className={styles.acronyms}>
        ...
        <span
          className={
            !props.portuguese ? styles.current_acro : styles.other_acro
          }
          style={acronymHover}
        >
          EN
